...
export default async function handler(req, res) {
    ...
    try{
        ...
        const { siteMode, muid } = req.query; // extract information from query parameters

        // Validate required parameters
        if(!access_key || !secret_key || !siteMode || !muid) {
        ...
        const apiURL = apiBaseURL + '/iai-api/pub/cp_used_account.check'; // construct API URL
